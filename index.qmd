...
This motivated the first approach that edits the environmental variable directly. Note that once you try this approach, it'll change `topic-3` to `_topic-3`, so you'll want to manually change it back.
